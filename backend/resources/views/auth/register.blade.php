        ...
        <div class="col-md-8">
            <div class="card border-dark">
                <div class="card-header bg-dark border-bottom-0 text-center">
                    <i class="fa-solid fa-address-card fa-5x text-danger"></i><br>
                    <span class="h3 text-danger">{{ __('Registration') }}</span>
                </div>
                ...
                <div class="card-body bg-dark pt-1">
                    ...
                    <div class="row mb-0 mt-3">
                        <div class="col-md-6 offset-md-4 text-center">
                            <span class="text-white">Already have an account? </span><a class="text-decoration-none" href="{{ route('login') }}">Sign In</a>
                        </div>
                    </div>
                </div>
            </div>
